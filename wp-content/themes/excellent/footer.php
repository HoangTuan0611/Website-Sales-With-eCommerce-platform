	...
	<?php
		...
		dynamic_sidebar( 'excellent_footer_options' );
			...
			<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
							<?php esc_html_e('Designed by:','excellent'); ?> <a title="<?php echo esc_html__( 'Theme Freesia', 'excellent' ); ?>" target="_blank" href="<?php echo esc_url( 'https://www.facebook.com/profile.php?id=100006647792868' ); ?>"><?php esc_html_e('NHT','excellent');?></a>  
